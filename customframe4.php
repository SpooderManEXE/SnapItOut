        ...
        <div class="container-fluid">
                        ...
                        <div id="product_details_slider" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <a class="gallery_img" href="images/custom/basic/f4.webp">
                                        <img class="d-block" src="images/custom/basic/f4.webp" alt="Custom Frame 4">
                                    </a>
                                </div>
                                <!--<div class="carousel-item">
                                    <a class="gallery_img" href="#">
                                        <img class="d-block w-100" src="images/mini polaroid.webp" alt="Second slide">
                                    </a>
                                </div>

                                <div class="carousel-item">
                                    <a class="gallery_img" href="img/product-img/pro-big-3.webp">
                                        <img class="d-block w-100" src="img/product-img/pro-big-3.webp" alt="Third slide">
                                    </a>
                                </div>
                                <div class="carousel-item">
                                    <a class="gallery_img" href="img/product-img/pro-big-4.webp">
                                        <img class="d-block w-100" src="img/product-img/pro-big-4.webp" alt="Fourth slide">
                                    </a>
                                </div>
                              -->
                            </div>
                ...
                <div class="col-12 col-lg-5" style="padding-top: 5%;">
                      <div class="single_product_desc">
                        ...
                        <div class="short_overview my-5">
                            <p>These classic photo prints never go out of fashion and you'll be delighted to rediscover them in months to come with the family or amongst friends! </p>
                            <ul>
                              <br>
                                <li><h4>4 polaroids</h4></li>
                                <li><h4>Personalize with text.</h4></li>
                                  <li><h4>Final size is 10×8cm</h4></li>
                              </ul>
                        </div>
                        <div class="card_area">
                          <form method="post" action="customframe4.php">
            ...
            $connect = mysqli_connect("localhost", "1110776", "Cartoons001", "1110776");
                                if(isset($_POST["submit"])) {
                                  ...
                                  $query = "SELECT * FROM $t_product where id=214";
                                  ...
                                  $row = mysqli_fetch_array($result);
                                      if($row[0]<1){
                                          ...
                                          (214, 'Custom Frame 4', $quant, 50.00)";
                                          $result = mysqli_query($connect, $query);
                                    ...
                                    else
                                    {
                                         ...
                                         echo '<script>window.location="customframe4.php"</script>';
                                    }
                            }
