        ...
        <div class="container-fluid">
                        ...
                        <div id="product_details_slider" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <a class="gallery_img" href="images/custom/mini/fm3.webp">
                                        <img class="d-block" src="images/custom/mini/fm3.webp" alt="Custom Frame 3">
                                    </a>
                                </div>
                ...
                <div class="col-12 col-lg-5" style="padding-top: 5%;">
                      <div class="single_product_desc">
                        ...
                        <div class="short_overview my-5">
                            <p>They say bigger is better, the person who created that phrase clearly didn’t see our Mini Polaroids!  </p>
                            <ul>
                              <br>
                                <li><h4>8 polaroids</h4></li>
                                <li><h4>Personalize with text.</h4></li>
                                  <li><h4>Final size is 5.5×8cm</h4></li>
                              </ul>
                        </div>
                        <div class="card_area">
                          <form method="post" action="custommframe3.php">
            ...
            $connect = mysqli_connect("localhost", "1110776", "Cartoons001", "1110776");
                                if(isset($_POST["submit"])) {
                                  ...
                                  $query = "SELECT * FROM $t_product where id=223";
                                  ...
                                  $row = mysqli_fetch_array($result);
                                      if($row[0]<1){
                                          ...
                                          (223, 'Custom Mini Frame 3', $quant, 55.00)";
                                          $result = mysqli_query($connect, $query);
                                    ...
                                    else
                                    {
                                         ...
                                         echo '<script>window.location="custommframe3.php"</script>';
                                    }
                            }
