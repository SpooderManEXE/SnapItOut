        ...
        <div class="container-fluid">
                        ...
                        <div id="product_details_slider" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <a class="gallery_img" href="images/stripframe.webp">
                                        <img class="d-block " src="images/stripframe.webp" alt="First slide">
                                    </a>
                                </div>
                    ...
                    <div class="single_product_desc">
                        ...
                        <div class="product-meta-data">
                            ...
                            <a href="product-details.html">
                                <h6>Flower Frame Photostrip Polaroids</h6>
                            </a>
                            <!-- Ratings & Review -->
                        ...
                        <div class="short_overview my-5">
                            <p>Go retro with photobooth-style photo strip prints. Perfect for birthdays and event favors, bookmarks, scrapbooking, traveler’s notebooks and more!</p>
                            <ul>
                              <br>
                                <li><h4>5 strips - 15 photos</h4></li>
                                <li><h4>Personalize with text.</h4></li>
                                  <li><h4>Final size is 5×15cm</h4></li>
                              </ul>
                        </div>
                        <div class="card_area">
                          <form method="post" action="flowerphotostrip.php">
            ...
            $connect = mysqli_connect("localhost", "1110776", "Cartoons001", "1110776");
                                if(isset($_POST["submit"])) {
                                  ...
                                  $query = "SELECT * FROM $t_product where id=32";
                                  ...
                                  $row = mysqli_fetch_array($result);
                                      if($row[0]<1){
                                          ...
                                          (32, 'Flower Photostrip', $quant, 55.00)";
                                          $result = mysqli_query($connect, $query);
                                    ...
                                    else
                                    {
                                         ...
                                         echo '<script>window.location="flowerphotostrip.php"</script>';
                                    }
                            }
