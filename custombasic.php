                        ...
                        <div class="row">
                            <div class="col-lg-6 col-sm-6">
                                <div class="single_product_item">
                                    <a href="customframe1.php"><img src="images/custom/basic/f1.webp" alt="Custom Frame 1" class="img-fluid">
                            ...
                            <div class="col-lg-6 col-sm-6">
                                <div class="single_product_item">
                                    <a href="customframe2.php"><img src="images/custom/basic/f2.webp" alt="Custom Frame 2" class="img-fluid">
                            ...
                            <div class="col-lg-6 col-sm-6">
                                <div class="single_product_item">
                                    <a href="customframe3.php"><img src="images/custom/basic/f3.webp" alt="Custom Frame 3" class="img-fluid">
                            ...
                            <div class="col-lg-6 col-sm-6">
                                <div class="single_product_item">
                                    <a href="customframe4.php"><img src="images/custom/basic/f4.webp" alt="Custom Frame 4" class="img-fluid">
                            ...
                            <div class="col-lg-6 col-sm-6">
                                <div class="single_product_item">
                                    <a href="customframe5.php"><img src="images/custom/basic/f5.webp" alt="Custom Frame 5" class="img-fluid">
                            ...
                            <div class="col-lg-6 col-sm-6">
                                <div class="single_product_item">
                                    <a href="customframe6.php"><img src="images/custom/basic/f6.webp" alt="Custom Frame 6" class="img-fluid">
                            ...
                            <div class="col-lg-6 col-sm-6">
                                <div class="single_product_item">
                                    <a href="customframe7.php"><img src="images/custom/basic/f7.webp" alt="Custom Frame 7" class="img-fluid">
                            ...
                            <div class="col-lg-6 col-sm-6">
                                <div class="single_product_item">
                                    <a href="customframe8.php"><img src="images/custom/basic/f8.webp" alt="Custom Frame 8" class="img-fluid">
                                    <h3> Frame 8 Polaroid </h3>
                                    <p>From ₹50</p></a>
                                </div>
                            </div>
                        </div>
