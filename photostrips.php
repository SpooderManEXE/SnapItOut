                        ...
                        <div class="row">
                            <div class="col-lg-6 col-sm-6">
                                <div class="single_product_item">
                                    <a href="photostrip.php"><img src="images/strip.webp" alt="#" class="img-fluid">
                                    <h3> Basic Photostrip Polaroids</h3>
                                    <p>From ₹50</p></a>
                                </div>
                            </div>
                            <div class="col-lg-6 col-sm-6">
                                <div class="single_product_item">
                                     <a href="flowerphotostrip.php"><img src="images/stripframe.webp" alt="#" class="img-fluid">
                                    <h3>Flower Frame Photostrip Polaroids </h3>
                                    <p>From ₹55</p></a>
                                </div>
                            </div>
                        </div>
