            ...
            <div class="row">
                        ...
                        <div id="product_details_slider" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <a class="gallery_img" href="images/custom/basic/f3.webp">
                                        <img class="d-block " src="images/custom/basic/f3.webp" alt="Custom Frame 3">
                                    </a>
                                </div>
                ...
                <div class="col-12 col-lg-5" style="padding-top: 5%;">
                      <div class="single_product_desc">
                        ...
                        <div class="card_area">
                          <form method="post" action="customframe3.php">
                                ...
                                if(isset($_POST["submit"])) {
                                  ...
                                  $row = mysqli_fetch_array($result);
                                      if($row[0]<1){
                                          ...
                                          (213, 'Custom Frame 3', $quant, 50.00)";
                                          $result = mysqli_query($connect, $query);
                                    ...
                                    else
                                    {
                                         ...
                                         echo '<script>window.location="customframe3.php"</script>';
                                    }
                            }
