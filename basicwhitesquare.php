                        ...
                        <div id="product_details_slider" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <a class="gallery_img" href="images/square.webp">
                                        <img class="d-block" src="images/square.webp" alt="Square Polaroid">
                                    </a>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-12 col-lg-5" style="padding-top: 5%;">
                      <div class="single_product_desc">
                        ...
                        <div class="short_overview my-5">
                            <p>With its sharp, boxy design, Square Polaroids fit right into the world of the '80s, turning instant analog photography into a pop culture icon.
  </p>
                            <ul>
                              <br>
                                <li><h4>4 polaroids</h4></li>
                                <li><h4>Personalize with text.</h4></li>
                                  <li><h4>Final size is 10x10cm</h4></li>
                              </ul>
                        </div>
                        <div class="card_area">
                          <form method="post" action="basicwhitesquare.php">
                          ...
                          <div class="add_to_cart" style="text-align: center;">
                                ...
                                if(isset($_POST["submit"])) {
                                  ...
                                  $query = "SELECT * FROM $t_product where id=13";
                                  ...
                                  $row = mysqli_fetch_array($result);
                                      if($row[0]<1){
                                          ...
                                          (13, 'Square White Polaroid', $quant, 40.00)";
                                          $result = mysqli_query($connect, $query);
                                    ...
                                    else
                                    {
                                         ...
                                         echo '<script>window.location="basicwhitesquare.php"</script>';
                                    }
                            }
