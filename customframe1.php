            ...
            <div class="row">
                        ...
                        <div id="product_details_slider" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <a class="gallery_img" href="images/custom/basic/f1.webp">
                                        <img class="d-block" src="images/custom/basic/f1.webp" alt="Custom Frame 1">
                                    </a>
                                </div>
                ...
                <div class="col-12 col-lg-5" style="padding-top: 5%;">
                      <div class="single_product_desc">
                        ...
                        <div class="card_area">
                          <form method="post" action="customframe1.php">
                          ...
                          <div class="add_to_cart" style="text-align: center;">
                                ...
                                if(isset($_POST["submit"])) {
                                  ...
                                  $query = "SELECT * FROM $t_product where id=211";
                                  ...
                                  $row = mysqli_fetch_array($result);
                                      if($row[0]<1){
                                          ...
                                          (211, 'Custom Frame 1', $quant, 50.00)";
                                          $result = mysqli_query($connect, $query);
                                    ...
                                    else
                                    {
                                         ...
                                         echo '<script>window.location="customframe1.php"</script>';
                                    }
                            }
