        ...
        <div class="container-fluid">
            ...
            <div class="row">
                      ...
                      <div id="product_details_slider" class="carousel slide" data-ride="carousel">
                          ...
                          <div class="carousel-inner">
                              <div class="carousel-item active">
                                  <a class="gallery_img" href="images/polaroid.webp">
                                      <img class="d-block" src="images/polaroid.webp" alt="Basic White Polaroid">
                                  </a>
                              </div>
              ...
              <div class="col-12 col-lg-5" style="padding-top: 5%;">
                      <div class="single_product_desc">
                        ...
                        <div class="card_area">
                          <form method="post" action="basicwhite.php">
            ...
            $connect = mysqli_connect("localhost", "1110776", "Cartoons001", "1110776");
                                if(isset($_POST["submit"])) {
                                  ...
                                  $query = "SELECT * FROM $t_product where id=11";
                                  ...
                                  $row = mysqli_fetch_array($result);
                                    ...
                                    else
                                    {
                                         ...
                                         echo '<script>window.location="basicwhite.php"</script>';
                                    }
                            }
