            ...
            <div class="row">
                        ...
                        <div id="product_details_slider" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <a class="gallery_img" href="images/custom/basic/f7.webp">
                                        <img class="d-block " src="images/custom/basic/f7.webp" alt="Custom Frame 7">
                                    </a>
                                </div>
                                <!--<div class="carousel-item">
                                    <a class="gallery_img" href="#">
                                        <img class="d-block " src="images/mini polaroid.webp" alt="Second slide">
                                    </a>
                                </div>

                                <div class="carousel-item">
                                    <a class="gallery_img" href="img/product-img/pro-big-3.webp">
                                        <img class="d-block " src="img/product-img/pro-big-3.webp" alt="Third slide">
                                    </a>
                                </div>
                                <div class="carousel-item">
                                    <a class="gallery_img" href="img/product-img/pro-big-4.webp">
                                        <img class="d-block " src="img/product-img/pro-big-4.webp" alt="Fourth slide">
                                    </a>
                                </div>
                              -->
                            </div>
                ...
                <div class="col-12 col-lg-5" style="padding-top: 5%;">
                      <div class="single_product_desc">
                        ...
                        <div class="card_area">
                          <form method="post" action="customframe7.php">
                          ...
                          <div class="add_to_cart" style="text-align: center;">
                                ...
                                if(isset($_POST["submit"])) {
                                  ...
                                  $query = "SELECT * FROM $t_product where id=217";
                                  ...
                                  $row = mysqli_fetch_array($result);
                                      if($row[0]<1){
                                          ...
                                          (217, 'Custom Frame 7', $quant, 50.00)";
                                          $result = mysqli_query($connect, $query);
                                    ...
                                    else
                                    {
                                         ...
                                         echo '<script>window.location="customframe7.php"</script>';
                                    }
                            }
