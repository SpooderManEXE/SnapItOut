        ...
        <div class="container-fluid">
            ...
            <div class="row">
                        ...
                        <div id="product_details_slider" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <a class="gallery_img" href="images/custom/mini/fm4.webp">
                                        <img class="d-block " src="images/custom/mini/fm4.webp" alt="Custom Frame 4">
                                    </a>
                                </div>
                ...
                <div class="col-12 col-lg-5" style="padding-top: 5%;">
                      <div class="single_product_desc">
                        ...
                        <div class="card_area">
                          <form method="post" action="custommframe4.php">
            ...
            $connect = mysqli_connect("localhost", "1110776", "Cartoons001", "1110776");
                                if(isset($_POST["submit"])) {
                                  ...
                                  $query = "SELECT * FROM $t_product where id=224";
                                  ...
                                  $row = mysqli_fetch_array($result);
                                      if($row[0]<1){
                                          ...
                                          (224, 'Custom Mini Frame 4', $quant, 55.00)";
                                          $result = mysqli_query($connect, $query);
                                    ...
                                    else
                                    {
                                         ...
                                         echo '<script>window.location="custommframe4.php"</script>';
                                    }
                            }
